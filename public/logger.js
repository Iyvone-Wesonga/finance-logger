...
greetme(me);
//INTERFACES WITH CLASSES..the letetr can be implemented in classes, remember to export and import form any module you create
//Create its module, import to classes tpo strcuture the methods
//having the hasformatter interface allows specifying the new instances of the classes to also contain the interface
let docOne;
let docTwo; //these two have the hasformatter interfcae for any methods in them, these two however acn be linked to the 
